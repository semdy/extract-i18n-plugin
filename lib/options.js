...
const defaultOptions = {
  ...
  importIdentifier: null, // 自定义导入的标识符名称，如果不传则默认为translateKey配置的值，对svelte-i18n比较有用，例如：`import { t } from "svelte-i18n"`，但模板里使用的是auto-subscription语法`$t()`, 这时如果开启了`rewrite`模式, `importIdentifier`应该设为`t`.
  ...
  extraImportIdentifier: null, // 额外的导入项的标识符名称，如：import { t, customImport } from "@/i18n"
